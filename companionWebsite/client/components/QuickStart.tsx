            ...
            <p>
              <p className="box-background"></p>
                <code className="box-background code">
                  ...
                  <span className="token symbols">({'{'} </span>
                  <br></br>
                  <span className="token key">  clientId</span>
                  <span className="token symbols">: '</span>
                  <span className="token names">myapp</span>
                  <span className="token symbols">',</span>
                  <br></br>
                  <span className="token key">  brokers</span>
                  <span className="token symbols">: [`${'{'}</span>
                  ...
                  <span className="token names">producer</span>
                  <span className="token symbols">);</span>
                  <span className="token comments"> // Invoke kafkaQ's trackProducer method with your producer as the argument</span>
                  <br></br>
                  <br></br>
                  <span className="token keywords">const </span>
                  ...
                  <span className="token symbols">({'{'}</span>
                  <br></br>
                  <span className="token key">  topic</span>
                  <span className="token symbols">: '</span>
                  <span className="token names">Users</span>
                  <span className="token symbols">',</span>
                  <br></br>
                  <span className="token key">  messages</span>
                  <span className="token symbols">: [{'{'}</span>
            ...
            <p>
              <p className="box-background"></p>
                <code className="box-background code">
                  ...
                  <span className="token symbols">({'{'}</span>
                  <br></br>
                  <span className="token key">  groupId</span>
                  <span className="token symbols">: '</span>
                  <span className="token names">test</span>
                  <span className="token symbols">',</span>
                  <br></br>
                  ...
                  <span className="token symbols">',</span>
                  <br></br>
                  <span className="token key">  fromBeginning</span>
                  <span className="token symbols">: </span>
                  ...
                  <span className="token names">consumer</span>
                  <span className="token symbols">);</span>
                  <span className="token comments"> // Invoke kafkaQ's trackconsumer method with your consumer as the argument</span>
                  <br></br>
                  <br></br>
                  <span className="token keywords">await </span>
                  <span className="token names">consumer</span>
                  ...
                  <span className="token symbols">{'{'}</span>
                  <br></br>
                  <span className="token comments">// Execute some code for each message</span>
                  <br></br>
                  <span className="token symbols">{'}'},</span>
                  <br></br>
                  <span className="token symbols">{'}'});</span>
